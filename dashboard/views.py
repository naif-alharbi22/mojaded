...
def view_dashboard(request):
    ...
    active_subscriptions = subs.filter(status=SubscriptionStatus.objects.get(name="active")).count()
    active_subscriptions_last = subs.filter(
        status=SubscriptionStatus.objects.get(name="active"),
        created_at__lt=this_month_start,
    ).count()
    monthly_revenue = subs.filter(
        status=SubscriptionStatus.objects.get(name="active"),
    ...
    context = {
        ...
        "active_subscriptions_delta": _pct_change(active_subscriptions, active_subscriptions_last),
